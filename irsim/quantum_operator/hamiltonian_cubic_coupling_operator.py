...
from irsim.quantum_operator import (
        JahnTellerTransitOperator as JTT,
        HamiltonianOneCouplingOperator,
        )

'''
Contents:
    (1) HamiltonianOneCubicCoupling (class)
    (2) HamiltonianCubicCoupling (class)
'''

class HamiltonianOneCubicCouplingOperator(HamiltonianOneCouplingOperator):
    ...
    def set_coupling_constant(cls, DIC):
        ...
        HamiltonianOneCubicCouplingOperator.DIC_COUPLING_CONSTANT = DIC
    ...
    def set_coupling_matrix(cls, DIC):
        ...
        HamiltonianOneCubicCouplingOperator.DIC_COUPLING_MATRIX = DIC
    ...
    def set_reduced_matrix_element(cls, DIC):
        '''dict data of reduced matrix element is in reduced_matrix_element.py
        The obtained format is like this:
        DIC_JT_TRANSITION = {
                # ((Alpha, J, P), (Alpha, J, P)): XI
                (Key(1, 0, 1), Key(1, 2, -1)): -0.35921,
                }
        '''
        HamiltonianOneCubicCouplingOperator.DIC_REDUCED_MATRIX_ELEMENT = DIC
    ...
    #def merge_coupling_database(DIC_JT_TRANSIT, DIC_COUP_MTRX):
        ...
        HamiltonianOneCubicCouplingOperator.DIC_MATRIX_RME = dic
...
class HamiltonianCubicCouplingOperator(HamiltonianOneCubicCouplingOperator):
    def __init__(self, *Qs):
        qop = self._clean(sum(HamiltonianOneCubicCouplingOperator(Q) for Q in Qs))
...
if __name__ == '__main__':
    ...
    HamiltonianCubicCouplingOperator.set_coupling_matrix(d)
